...
Followed by the description of the transformation, and the input and output as the example.\
...
Example: Input: [1, 2, 3, 4]; output: [10, 20, 30, 40]
Q: seq_a=['5 b', '8 x', '98x'], seq_b = ['5', '8', '98']
...
Example: Input: ['5 b', '8 x', '98x']; output: ['5', '8', '98']
"""
