...
if __name__ == '__main__':
    ...
    # source_path = input_path / 'gpt_more_outputs_3.5'/ 'all.jsonl'
    # output_path = input_path / 'gpt_more_outputs_desc_3.5'
    ...
    # source_path = input_path / 'gpt_more_outputs_20_3.5'/ 'all.jsonl'
    # fixed_source_path = input_path / 'gpt_more_outputs_20_3.5_fix'/ 'all.jsonl'
    # # output_path = input_path / 'struct_gpt_more_outputs_desc_20_3.5'
    # origin_output_path = input_path / 'struct_gpt_more_outputs_desc_20_3.5'
    # output_path = input_path / 'struct_gpt_more_outputs_desc_20_3.5_fix'
    # source_path = input_path / 'gpt_more_outputs_20_3.5'/ 'all.jsonl'
    output_path = input_path / 'struct_gpt_origin_desc'
    ask_all_gpt(source_path, output_path)
